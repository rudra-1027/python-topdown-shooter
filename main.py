...
class Game(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.player=Player()
        joy_size = (sdp(150), sdp(150))
        self.joystick=JoyStick(size_hint=(None, None),size=joy_size,pos_hint={"x": 0.05, "y": 0.05})
        self.AttackJoystick=AttackJoystick(size_hint=(None, None),size=joy_size,pos_hint={"right": 0.95, "y": 0.05})
        ...
        hbar_h = sdp(80)
        self.player.healthBar = PlayerHealthBar(max_health=self.player.max_health,health=self.player.health,size_hint=(None, None),size=(hbar_w, hbar_h),pos_hint={"x": 0.02, "top": 0.98})
